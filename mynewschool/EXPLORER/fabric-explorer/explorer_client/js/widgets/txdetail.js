...
module.exports = function(id) {
	var extended = {
		...
		template: _.template('<div class="info-table"> <table style="width: 100%; table-layout: fixed;" class="table table-striped"> ' +
			...
			'<tr> <td  style="width: 120px;">key</td> <td class="value" contentEditable="false" style="text-overflow: ellipsis; white-space: nowrap; overflow: hidden;"><%=res.bckey %></td> </tr>' +
            '<tr> <td  style="width: 120px;">value</td> <td class="value" contentEditable="false" style=" overflow: auto;"><%=res.bcvalue %> </td> </tr>' +
            '</tbody> </table> <div>'),
