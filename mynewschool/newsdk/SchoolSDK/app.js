...
app.post('/channels/chaincodes/query', function(req, res) {
	...
	.then(function(message) {
		...
		// 	message: message
		// });
		if(message.indexOf("status: 500")>=0){
		var sss=message.split("message");
		var sss2=sss[1];
		var sss3=sss2.replace(":","");
		var sss3=sss3.replace(")","");
		console.log("asdasd+++"+sss);
		console.log("asdasd+++"+sss2);
		console.log("asdasd+++"+sss3);
		//sss3="{"+sss3+"}";		
		res.json({
			success: false,
			message: JSON.parse(sss3)
		});
		}
		else{		
		res.json({
